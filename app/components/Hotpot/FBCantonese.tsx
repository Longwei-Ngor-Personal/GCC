      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex items-center gap-6 max-w-5xl mx-auto">
            {/* Small logo */}
            <Image
              src="/hotpot/cantoneseseafood.jpg"   // replace with your logo path
              alt="Cantonese Seafood Logo"
              width={300}
              height={300}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div
                ...
                onClick={() => setSelectedImage(`/hotpot/sea${item}.jpg`)}
              >
                <Image
                  src={`/hotpot/sea${item}.jpg`}
